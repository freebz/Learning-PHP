...
// 이 배열은 display_form(), validate_from(), process_from()에서 사용되므로
// 전역 영역에 선언한다.
...
function show_form($errors = array()) {
    ...
    // 폼 출력과 관련된 무든 HTML은 별도의 파일로 완전히 분리한다.
...
$sweet({$input['size']}), $main_dish_1, $main_dish_2를 주문사혔습니다.
배달 여부: $delivery
_ORDER_;
